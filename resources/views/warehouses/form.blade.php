...
@php
    ...
    $pageTitle = $isEdit ? 'Edit Warehouse' : 'Add Warehouse';
@endphp
...
@section('breadcrumbs')
    ...
    <a href="{{ route('warehouses.index') }}" class="hover:text-gray-700">Warehouses</a>
    <span class="mx-1">/</span>
...
@section('page-header')
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
            {{ $isEdit ? 'Update warehouse details.' : 'Fill in the details to create a new warehouse.' }}
        </p>
    </div>
@endsection
...
@section('content')
    <form method="POST"
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            <h3 class="text-base font-semibold text-gray-900 mb-4">Warehouse Information</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="3"
                        ...
                        placeholder="Full warehouse address">{{ old('address', $warehouse->address) }}</textarea>
                </div>
                ...
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-sm font-medium text-gray-700">Set as default warehouse</span>
                    </label>
                </div>
        ...
        <div class="flex items-center justify-end gap-3">
            @include('components.button', ['label' => 'Cancel', 'type' => 'secondary', 'href' => route('warehouses.index')])
            @include('components.button', [
                'label' => $isEdit ? 'Update Warehouse' : 'Create Warehouse',
                'type' => 'primary',
                'buttonType' => 'submit',
