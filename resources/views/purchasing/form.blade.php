...
@php
    $isEdit = $order->exists;
    $pageTitle = $isEdit ? 'Edit ' . $order->number : 'New Purchase Order';
@endphp
...
@section('page-header')
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
            {{ $isEdit ? 'Update order details and items.' : 'Create a new purchase order from a supplier.' }}
        </p>
    </div>
@endsection
    ...
    <form method="POST"
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="expected_date" class="block text-sm font-medium text-gray-700 mb-1">Expected Delivery</label>
        ...
        <div class="flex items-center justify-end gap-3">
            @include('components.button', ['label' => 'Cancel', 'type' => 'ghost', 'href' => route('purchasing.index')])
