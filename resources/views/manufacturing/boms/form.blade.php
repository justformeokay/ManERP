...
@php
    $isEdit = $bom->exists;
    $pageTitle = $isEdit ? 'Edit BOM' : 'New Bill of Materials';
@endphp
...
@section('page-header')
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
            {{ $isEdit ? 'Update the recipe and materials.' : 'Define a recipe for manufacturing a product.' }}
        </p>
    </div>
@endsection
...
@section('content')
    ...
    <form method="POST"
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            <h3 class="text-base font-semibold text-gray-900 mb-4">BOM Details</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-1">BOM Name <span class="text-red-500">*</span></label>
                    <input type="text" id="name" name="name" value="{{ old('name', $bom->name) }}" required
                        ...
                        placeholder="e.g. Assembly — Product X">
                    @error('name') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label for="product_id" class="block text-sm font-medium text-gray-700 mb-1">Output Product <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="output_quantity" class="block text-sm font-medium text-gray-700 mb-1">Output Quantity <span class="text-red-500">*</span></label>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="2"
                        class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-700 focus:border-primary-500 focus:bg-white focus:outline-none focus:ring-1 focus:ring-primary-500 transition"
                        placeholder="Optional description...">{{ old('description', $bom->description) }}</textarea>
                </div>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-base font-semibold text-gray-900">Materials / Components</h3>
