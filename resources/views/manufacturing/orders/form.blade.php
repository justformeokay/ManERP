...
@section('page-header')
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
            {{ $isEdit ? 'Update order details and scheduling.' : 'Create a new production work order.' }}
        </p>
    </div>
@endsection
    ...
    <form method="POST"
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {{-- BOM --}}
                <div>
                    <label for="bom_id" class="block text-sm font-medium text-gray-700 mb-1">Bill of Materials <span class="text-red-500">*</span></label>
                ...
                {{-- Planned Quantity --}}
                <div>
                    <label for="planned_quantity" class="block text-sm font-medium text-gray-700 mb-1">Planned Quantity <span class="text-red-500">*</span></label>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="planned_start" class="block text-sm font-medium text-gray-700 mb-1">Planned Start</label>
                ...
                <div>
                    <label for="planned_end" class="block text-sm font-medium text-gray-700 mb-1">Planned End</label>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <textarea name="notes" id="notes" rows="3"
                ...
                placeholder="Optional production notes...">{{ old('notes', $order->notes) }}</textarea>
            @error('notes') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
        </div>

        {{-- Actions --}}
        <div class="flex items-center justify-end gap-3">
            @include('components.button', ['label' => 'Cancel', 'type' => 'ghost', 'href' => route('manufacturing.orders.index')])
            @include('components.button', ['label' => $isEdit ? 'Update Order' : 'Create Order', 'type' => 'primary', 'buttonType' => 'submit'])
        </div>
    </form>
@endsection
