...
@section('page-header')
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Configure your company information and system preferences.</p>
    </div>
@endsection
...
@section('content')
    <form method="POST" action="{{ route('settings.update') }}" class="space-y-6">
        ...
        {{-- System Preferences --}}
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            <h3 class="text-base font-semibold text-gray-900 mb-4">System Preferences</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="default_currency" class="block text-sm font-medium text-gray-700 mb-1">Default Currency <span class="text-red-500">*</span></label>
