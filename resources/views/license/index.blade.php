...
@section('page-header')
    ...
    <a href="{{ route('license.activate') }}"
       class="inline-flex items-center gap-2 rounded-xl bg-primary-600 px-4 py-2.5 text-sm font-semibold text-black shadow-md border hover:bg-primary-700 transition mt-3">
