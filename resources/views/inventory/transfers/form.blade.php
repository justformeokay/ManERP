...
@section('breadcrumbs')
    ...
    <a href="{{ route('inventory.transfers.index') }}" class="hover:text-gray-700">Stock Transfers</a>
    <span class="mx-1">/</span>
...
@section('page-header')
    ...
    <p class="mt-1 text-sm text-gray-500">Move inventory from one warehouse to another.</p>
@endsection
...
@section('content')
    <form method="POST" action="{{ route('inventory.transfers.store') }}" class="space-y-6" x-data="transferForm()">
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            <h3 class="text-base font-semibold text-gray-900 mb-5">Transfer Details</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                {{-- From Warehouse --}}
                <div>
                    <label for="from_warehouse_id" class="block text-sm font-medium text-gray-700 mb-1.5">From Warehouse <span class="text-red-500">*</span></label>
                    ...
                    <p class="mt-1 text-xs" :class="availableStock !== null ? (availableStock > 0 ? 'text-green-600' : 'text-red-600') : 'text-gray-400'">
                        <span x-show="availableStock !== null">Available: <span x-text="Number(availableStock).toLocaleString()"></span></span>
                        <span x-show="availableStock === null">Select product & warehouse to see stock</span>
                    </p>
                ...
                {{-- To Warehouse --}}
                <div>
                    <label for="to_warehouse_id" class="block text-sm font-medium text-gray-700 mb-1.5">To Warehouse <span class="text-red-500">*</span></label>
                ...
                {{-- Quantity --}}
                <div>
                    <label for="quantity" class="block text-sm font-medium text-gray-700 mb-1.5">Quantity <span class="text-red-500">*</span></label>
        ...
        <div class="flex items-center justify-end gap-3">
            @include('components.button', ['label' => 'Cancel', 'type' => 'secondary', 'href' => route('inventory.transfers.index')])
