...
@section('content')
    <form method="POST"
        ...
        {{-- Pricing & Stock --}}
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            <h3 class="text-base font-semibold text-gray-900 mb-4">Pricing & Stock</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    <label for="min_stock" class="block text-sm font-medium text-gray-700 mb-1">Min. Stock Alert</label>
        ...
        <div class="flex items-center justify-end gap-3">
            @include('components.button', ['label' => 'Cancel', 'type' => 'secondary', 'href' => route('inventory.products.index')])
